...
# app.layout = html.Div(className='container-fluid', style={'backgroundColor': '#ffffff', 'width': '100%' ,'height': '80%', 'color': '#000000', 'margin': '1%'}, children=[
#     dbc.Card([
#         dbc.CardBody([
...
#                     dbc.Row([
#                         dbc.Col(
#                             dcc.Graph(id='bar-chart', style={'height': '400px', 'margin-top': '5px'}), 
#                             width=12
#                         )
#                     ])
#                 ])
...
#             [
#                         dbc.Col(
#                             dcc.Graph(id='pie-chart', style={'height': '200px', 'margin': 'auto'}), 
...
#         title_yanchor='middle',  # Ancora verticalmente o título à parte superior
...
dash_app = dash.Dash(__name__, server=flask_app, external_stylesheets=[dbc.themes.BOOTSTRAP])

# Layout do aplicativo Dash
dash_app.layout = html.Div(className='container-fluid', style={'backgroundColor': '#ffffff', 'width': '100%' ,'height': '80%', 'color': '#000000', 'margin': '1%'}, children=[
    dbc.Card([
        dbc.CardBody([
            html.Div(className='header', children=[
                html.Img(src=r'data:image/png;base64,', style={'width': '200px', 'height': 'auto'}),

...
cv2.resizeWindow('YOLOv4 + Face Detection', 800, 600)  # Ajuste o tamanho conforme necessário
...
while True:
    ...
    if time.time() - start_time >= interval_seconds:
        ...
        try:
            ...
            print("Erro de conexão ao tentar enviar dados para a API:", e)
        except Exception as e:
            print("Ocorreu um erro durante a chamada à API:", e)
